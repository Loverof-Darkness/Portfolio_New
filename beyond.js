(() => {
  const activities = [
    ...
    },
    {
      ...
      image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Volleyball_Team_Playing_on_Court.jpg',
      accent: '#00ffb3'
    },
    {
      title: 'Badminton',
      ...
      image: 'https://commons.wikimedia.org/wiki/Special:FilePath/India_badminton_player.jpg',
      accent: '#ff2bd6'
    },
    {
      ...
      image: 'https://commons.wikimedia.org/wiki/Special:FilePath/RGB_desktop_computer_setup_with_keyboard_and_monitor.jpg',
      accent: '#8b5cf6'
    }
  ];

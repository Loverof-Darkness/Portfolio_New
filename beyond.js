(() => {
  ...
  function renderBeyond(){
    const section=Portfolio.renderPanel({
      ...
      .beyond-header{max-width:1100px;margin:0}.beyond-header h2{margin:0;font-size:clamp(48px,5.6vw,78px);line-height:.92;font-weight:950;letter-spacing:-.055em;${Portfolio.gradientText('linear-gradient(90deg,#fff,#00e5ff 45%,#8b5cf6)')}}.beyond-intro{margin:10px 0 0;max-width:820px;color:#cbd5e1;font-size:17px;font-weight:600;line-height:1.5}

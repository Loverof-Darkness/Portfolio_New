(()=>{'use strict';
const TOTAL=16,CORE=12,KEY='portfolio:background-unified-bag-v2';
...
const script=document.createElement('script');script.src=chosen<CORE?'./background-core.js?v=2':'./background-extras-core.js?v=2';script.async=false;script.dataset.backgroundChoice=String(chosen);document.head.appendChild(script);
})();
